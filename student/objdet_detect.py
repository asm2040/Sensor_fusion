...
def load_configs(model_name='fpn_resnet', configs=None):
    ...
    configs.lim_y = [-25, 25] # for mid_project
    # configs.lim_y = [-5,15] # for final_project
    configs.lim_z = [-1, 3]
...
def detect_objects(input_bev_maps, model, configs):
    ...
    if detections !=[]:
        ...
        for obj in detections:
            ...
            x = _y / configs.bev_height* (configs.lim_x[1]-configs.lim_x[0]) + configs.lim_x[0]# + cnf.boundary['minX']
            y = _x / configs.bev_width* (configs.lim_y[1]-configs.lim_y[0]) + configs.lim_y[0]# + cnf.boundary['minY']
