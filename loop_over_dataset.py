...
data_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'datasets', data_filename) # adjustable path in case this script is called from another working directory
#### for mid-project
# model='resnet'
# sequence="1"
